    ...
    io.sockets.on('connection', socket => {
      ...
      socket.on('disconnecting', () => {
        ...
        .then(res => {
          ...
          console.log(res.currentMembers)
          let removedMember = {};
          if (res.currentMembers) {
            ...
            if (res.controlledBy === socket.user_id) {
              controlle.rooms.put({controlledBy: null})
            ...
            socket.to(rooms[0]).emit('USER_LEFT', {currentMembers,}, message, releasedControl)
