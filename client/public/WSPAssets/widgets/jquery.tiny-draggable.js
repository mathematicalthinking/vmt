  ...
  $.fn.tinyDraggable = function(options) {
    ...
    return this.each(function() {
      ...
      function getTouchLoc(e) {
        // pageX for mouse events is e.touches[e.which].pageX for touch events
      ...
      function pressed(e) {
        ...
        dx = touchLoc.x - elLoc.left;
        dy = touchLoc.y - elLoc.top;
      ...
      function released(e) {
        var eventName =
          e.type === 'mouseup' ? 'mousemove.drag' : 'touchmove.drag';
