...
class ContentBox extends PureComponent{
  ...
  render() {
    ...
    const notifications = (this.props.notifications > 0) ? <div className={classes.Notification} data-testid="content-box-ntf"><span className={classes.NotificationCount}>{this.props.notifications}</span></div> : null;
    return (
    <Aux>
      <Link
