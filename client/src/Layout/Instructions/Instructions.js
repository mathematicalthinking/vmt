              ...
              <p className={classes.Description}>
                <ol type="1" className={classes.List}>
                  ...
                  <li className={classes.ListItem}>
                    ...
                    to the right place. If so, click the button, &quot;Yes,
                    looks right.&quot;
                  </li>
                  <li className={classes.ListItem}>
            ...
            <div className={classes.Content}>
              <p className={classes.Description}>
                <ol type="1" start="6" className={classes.List}>
                  ...
                  <li className={classes.ListItem}>
                    From the bottom left, click the blue &quot;Enter.&quot;
                    button to go in and start collaborating!
                  </li>
                </ol>
              </p>
              <DemoBrowser>
            ...
            <div id="template" className={classes.Content}>
              ...
              <p className={classes.Description}>
                <ol type="1" className={classes.List}>
                  ...
                  <li className={classes.ListItem}>
                    Give your template a name and -- if you like -- a
                    description. Then click &quot;Create a new template.&quot;
                  </li>
                  <li className={classes.ListItem}>
                    Select the rightmost option, &quot;Desmos Activity,&quot;
                    then click &quot;Next.&quot;
                  </li>
                  <li className={classes.ListItem}>
              ...
              <p className={classes.Description}>
                <ol type="1" className={classes.List}>
                  ...
                  <li className={classes.ListItem}>
                    ...
                    correspond with which participant you want to assign to
                    which room. When done, click &quot;Assign.&quot;{' '}
                  </li>
                </ol>
              </p>
              <DemoBrowser>
