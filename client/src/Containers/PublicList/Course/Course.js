...
class Course extends Component {
  state = {
    ...
    access: false,
    guestMode: false,
    currentCourse: {rooms: []}, // Right now I'm just saving currentCourse is state to compare the incoming props currentCourse to look for changes
    tabs: [
      {name: 'Rooms'},
      {name: 'Students'},
      {name: 'Grades'},
    ...
    return (
      <Aux>
        ...
        <DashboardLayout
          ...
          resource='course'
          resourceList={this.props.currentCourse.rooms}
        />
      </Aux>
        )
  }
