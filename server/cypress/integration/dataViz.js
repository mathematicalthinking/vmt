...
describe('Data Visualization', function() {
  ...
  it('filters the data', () => {
    ...
    cy.getTestElement('References-checkbox').click();
    cy.getTestElement('line-#5dd74a').should('not.be.visible');
    cy.getTestElement('line-#8d4adb').should('be.visible');
    cy.getTestElement('line-#99cc00').should('be.visible');
    ...
    // currently no remove events for this room
    cy.getTestElement('line-#99cc00').should('be.visible');
    cy.getTestElement('line-#4655d4').should('be.visible');
    cy.getTestElement('line-#c940ce').should('be.visible');
    cy.getTestElement('line-#fb4b02').should('be.visible');
    cy.getTestElement('line-#42770a').should('not.be.visible');
    cy.getTestElement('Update Style-checkbox').click();
    // currently no update-style events for this room
    cy.getTestElement('line-#99cc00').should('be.visible');
    cy.getTestElement('line-#4655d4').should('be.visible');
    cy.getTestElement('line-#c940ce').should('be.visible');
    cy.getTestElement('line-#fb4b02').should('be.visible');
    cy.getTestElement('line-#42770a').should('not.be.visible');
    cy.getTestElement('line-#cf2418').should('not.be.visible');
    cy.getTestElement('Drag-checkbox').click();
    // currently no drag events for this room
    cy.getTestElement('line-#99cc00').should('be.visible');
    cy.getTestElement('line-#4655d4').should('be.visible');
    cy.getTestElement('line-#c940ce').should('be.visible');
    cy.getTestElement('line-#fb4b02').should('be.visible');
    cy.getTestElement('line-#42770a').should('not.be.visible');
    cy.getTestElement('line-#cf2418').should('not.be.visible');
    cy.getTestElement('line-#ff8d14').should('not.be.visible');
    cy.getTestElement('Set Mode-checkbox').click();
    cy.getTestElement('line-#99cc00').should('be.visible');
    cy.getTestElement('line-#4655d4').should('be.visible');
    cy.getTestElement('line-#c940ce').should('be.visible');
    cy.getTestElement('line-#fb4b02').should('be.visible');
    ...
    cy.getTestElement('line-#cf2418').should('not.be.visible');
    cy.getTestElement('line-#ff8d14').should('not.be.visible');
    cy.getTestElement('line-#669999').should('be.visible');
  });
