...
cp app.js package.json socketInit.js sockets.js ./$2
cd $2
mkdir client
cp -r ../client/build/ ./client/
echo -e "\e[1;33m Zipping...\e[0m"
[[ $2 == staging ]] && zip VMT-STAGING.zip ./* || zip VMT-PRODUCTION.zip ./*
echo -e "\e[1;33m Copying zipped directory...\e[0m"
scp ./VMT-STAGING.zip "$1"@mathematicalthinking.org:/tmp/
echo -e "\e[1;33m Copying deploy-scripts\e[0m"
scp ../deploy-staging-2 "$1"@mathematicalthinking.org:/home/"$1"
